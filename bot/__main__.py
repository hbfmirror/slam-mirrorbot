...
def start(update, context):
    ...
    buttons.buildbutton("Channel", "https://t.me/hollybolly_films")
    buttons.buildbutton("Help", "https://t.me/hbf_supportbot")
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='HBF Mirrorbot Help',
        author_name='HBF Mirrorbot',
        author_url='https://t.me/hollybolly_films',
